...
CREATE TABLE `users` (
  ...
  `biographie` text,
  `nationalit├®` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `photo` longblob,
...
CREATE TABLE `voyages` (
  ...
  `date_d├®part` date NOT NULL DEFAULT (curdate()),
  `date_arriv├®e` date DEFAULT NULL,
  `id_user` int NOT NULL,
